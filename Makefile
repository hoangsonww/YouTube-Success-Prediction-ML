...
.PHONY: venv install install-dev train test lint serve-fastapi serve-flask smoke-api frontend-build frontend-dev format-all format-python format-prettier k8s-render-rolling k8s-render-canary k8s-render-bluegreen terraform-plan-aws terraform-plan-gcp terraform-plan-azure terraform-plan-oci
