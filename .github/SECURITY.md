...
This document describes the security vulnerability disclosure process for the **YouTube Success Prediction ML** project. It covers supported versions, reporting guidelines, response commitments, and safe-harbor protections for security researchers.
